...
@Edge
  ...
  Scenario: TC_002 As a vendor, email, and password must be entered and My Account must appear in the system
    Given GridChrome User goes to Hubcomfy
    And   Grid User clicks Sign In
    And   Grid User enters a valid email in the email box
    And   Grid User enters the valid password in the password box
    And   Grid User click the SIGN IN button
    Then  Grid The user confirms that they went to the My Account page
    And   Grid User quits page
